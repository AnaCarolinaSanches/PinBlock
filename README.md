...
Caused by: com.mendix.modules.microflowengine.MicroflowException: com.mendix.systemwideinterfaces.MendixRuntimeException: java.security.InvalidKeyException: Wrong key size
...
Caused by: com.mendix.core.CoreRuntimeException: com.mendix.systemwideinterfaces.MendixRuntimeException: java.security.InvalidKeyException: Wrong key size
	at com.mendix.basis.actionmanagement.ActionManager.executeSync(ActionManager.scala:110)

Caused by: com.mendix.systemwideinterfaces.MendixRuntimeException: java.security.InvalidKeyException: Wrong key size
...
Caused by: java.security.InvalidKeyException: Wrong key size
	...
	at cryptography.actions.JA_GeneratePinblock.executeAction(JA_GeneratePinblock.java:58)
	at cryptography.actions.JA_GeneratePinblock.executeAction(JA_GeneratePinblock.java:23)
