...
Caused by: com.mendix.modules.microflowengine.MicroflowException: com.mendix.systemwideinterfaces.MendixRuntimeException: java.lang.Exception: Erro inesperado: java.security.InvalidKeyException: invalid key format
...
Caused by: com.mendix.core.CoreRuntimeException: com.mendix.systemwideinterfaces.MendixRuntimeException: java.lang.Exception: Erro inesperado: java.security.InvalidKeyException: invalid key format
	at com.mendix.basis.actionmanagement.ActionManager.executeSync(ActionManager.scala:110)

Caused by: com.mendix.systemwideinterfaces.MendixRuntimeException: java.lang.Exception: Erro inesperado: java.security.InvalidKeyException: invalid key format
	at com.mendix.util.classloading.Runner$.withContextClassLoader(Runner.scala:23)

Caused by: java.lang.Exception: Erro inesperado: java.security.InvalidKeyException: invalid key format
	at cryptography.actions.JA_Criptografar.executeAction(JA_Criptografar.java:60)
	at cryptography.actions.JA_Criptografar.executeAction(JA_Criptografar.java:20)
...
Caused by: java.security.spec.InvalidKeySpecException: java.security.InvalidKeyException: invalid key format
	...
	at cryptography.actions.CryptographyRSA.getPublicKeyFromBase64(CryptographyRSA.java:15)
...
Caused by: java.security.InvalidKeyException: invalid key format
	...
	at java.base/sun.security.rsa.RSAPublicKeyImpl.<init>(RSAPublicKeyImpl.java:152)
	at java.base/sun.security.rsa.RSAPublicKeyImpl.newKey(RSAPublicKeyImpl.java:79)
	at java.base/sun.security.rsa.RSAKeyFactory.generatePublic(RSAKeyFactory.java:320)
	at java.base/sun.security.rsa.RSAKeyFactory.engineGeneratePublic(RSAKeyFactory.java:236)
	at java.base/java.security.KeyFactory.generatePublic(KeyFactory.java:352)
	at cryptography.actions.CryptographyRSA.getPublicKeyFromBase64(CryptographyRSA.java:15)
	at cryptography.actions.JA_Criptografar.executeAction(JA_Criptografar.java:38)
	at cryptography.actions.JA_Criptografar.executeAction(JA_Criptografar.java:20)
